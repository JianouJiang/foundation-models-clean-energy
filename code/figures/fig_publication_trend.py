...
def main():
    ...
    # Mark regime shift at 2023 (ChatGPT era) — per Illustrator/Statistician
    ax1.axvline(2023, color="0.5", ls=":", lw=1, alpha=0.7, zorder=2)
    ax1.text(2023.05, max(counts) * 0.92, "ChatGPT\nera", fontsize=7,
